...
export class ProcessingStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props: ProcessingStackProps) {
    ...
    const compositeFunction = this.createProcessingFunction(
      ...
      "index.handler",
      { SIGNALS_TABLE: signalsTable.tableName, DASHBOARD_STATE_TABLE: dashboardStateTable.tableName, AUDIT_TABLE: auditTable.tableName, EVENT_BUS_NAME: eventBus.eventBusName },
      signalsTable,
      dashboardStateTable,
      auditTable,
      eventBus
